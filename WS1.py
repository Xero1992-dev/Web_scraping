...
def get_job_details(query, page=1, date_posted="month"):
    ...
    headers = {"X-RapidAPI-Key": "1f6f4a2da0msh1079ef35e6125ecp1fb349jsn9ccea976b62f", "X-RapidAPI-Host": "jsearch.p.rapidapi.com"}
...
def write_to_csv(job_details, filename):
    ...
    fieldnames = ["title", "location", "coordinates", "salary", "job_link", "description", "Date"]
...
def main():
    ...
    for job_title in job_titles:
        job_details = get_job_details(f"{job_title} in Italy")
